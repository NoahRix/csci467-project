module.exports = app => {
    ...
    // app.post("/api/shipping_information/add", shippingInfo.pppppp); //-> this should add a record into the table with data that I send in
    // app.delete("/api/shipping_information/delete", shippingInfo.pppppp); //-> this should delete a record that matches the primary key I send in
}